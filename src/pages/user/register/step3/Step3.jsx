        ...
        <div className="side-form">
          <div className="form-box">
            ...
            <div className="form-control">
              <label className="lsOptionText" for="email">Telefone </label>
              <input type="text" min={0} className="input" placeholder="telefone" id="telefone" />
            </div>
            <div className="form-control">
              <label className="lsOptionText" for="email">Endereço </label>
              <input type="text" min={0} className="input" placeholder="endereco" id="endereco" />
            </div>

            <button type="submit" className="form-button" onClick={home}>Proximo</button>
